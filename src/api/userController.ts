...
export async function mailLogin(body: API.MailLoginRequest, options?: { [key: string]: any }) {
...
export async function setPassword(body: API.SetPasswordRequest, options?: { [key: string]: any }) {
