...
const BasicLayout: React.FC = () => {
  ...
  // 子页面不显示 TabBar
  const hideRoutes = ['/detail', '/orders', '/wallet', '/coupons', '/want-to-see', '/watched', '/settings', '/showtime', '/seat', '/order-confirm', '/payment', '/ticket', '/profile-edit', '/forgot-password', '/set-password'];
