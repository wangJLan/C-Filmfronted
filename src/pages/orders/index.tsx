...
const OrdersPage: React.FC = () => {
  ...
  if (!isLoggedIn) {
    return <div className={styles.page}><NavBar onBack={() => navigate('/user')} className={styles.nav}>我的订单</NavBar>
  ...
  return (
    <div className={styles.page}>
      <NavBar onBack={() => navigate('/user')} className={styles.nav}>我的订单</NavBar>
